...
class CustomLabel extends SliderComponentShape {
  static const CustomPaddleSliderValueIndicatorPathPainter _pathPainter =
      CustomPaddleSliderValueIndicatorPathPainter();
...
class CustomPaddleSliderValueIndicatorPathPainter {
  const CustomPaddleSliderValueIndicatorPathPainter();
